...
public partial class YuoNetworkManager
{
    ...
    public class NetworkConnectionModel
    {
        ...
        public NetworkConnectionModel(YuoNetworkManager manager, FacepunchTransport transport)
        {
            this.yuoNetworkManager = manager ?? throw new ArgumentNullException(nameof(manager), "游戏网络管理器不能为空");
